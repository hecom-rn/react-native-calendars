...
import { TimeInstance } from '@hecom/aDate';
...
class ReactComp extends Component {
  static propTypes = {
    ...
    selectedDay: PropTypes.instanceOf(TimeInstance),
    topDay: PropTypes.instanceOf(TimeInstance),
  };
  ...
  updateReservations(props) {
    ...
    if (this.list && !dateutils.sameDate(props.selectedDay, this.selectedDay, props.isDate)) {
  ...
  componentWillReceiveProps(props) {
    if (!dateutils.sameDate(props.topDay, this.props.topDay, props.isDate)) {
      this.setState({
        reservations: []
      }, () => {
